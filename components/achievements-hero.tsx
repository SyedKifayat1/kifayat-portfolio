    ...
    <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
          Recognition and milestones that mark my journey in web development, from industry awards to personal
          accomplishments.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12">
          <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-6 transform hover:scale-105 transition-all duration-300 glow-effect">
            ...
            <h3 className="font-serif font-semibold text-lg text-foreground mb-2">Industry Awards</h3>
            <p className="text-muted-foreground text-sm">Recognition from peers and organizations</p>
          </div>

          <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-6 transform hover:scale-105 transition-all duration-300 glow-effect">
            <Award className="h-8 w-8 text-primary mx-auto mb-3" />
            <h3 className="font-serif font-semibold text-lg text-foreground mb-2">Certifications</h3>
            <p className="text-muted-foreground text-sm">Professional credentials and qualifications</p>
          </div>

          <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-6 transform hover:scale-105 transition-all duration-300 glow-effect">
            <Star className="h-8 w-8 text-primary mx-auto mb-3" />
            <h3 className="font-serif font-semibold text-lg text-foreground mb-2">Milestones</h3>
            <p className="text-muted-foreground text-sm">Personal and professional achievements</p>
          </div>
        </div>
      </div>
    </section>

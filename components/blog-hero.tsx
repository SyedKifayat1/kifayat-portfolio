    ...
    <section className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
          Insights, tutorials, and thoughts on modern web development, design trends, and the latest technologies
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mt-12">
          <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-6 transform hover:scale-105 transition-all duration-300 glow-effect">
            ...
            <h3 className="font-serif font-semibold text-lg text-foreground mb-2">Tutorials</h3>
            <p className="text-muted-foreground text-sm">Step-by-step guides and how-tos</p>
          </div>

          <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-6 transform hover:scale-105 transition-all duration-300 glow-effect">
            <Lightbulb className="h-8 w-8 text-primary mx-auto mb-3" />
            <h3 className="font-serif font-semibold text-lg text-foreground mb-2">Insights</h3>
            <p className="text-muted-foreground text-sm">Industry trends and best practices</p>
          </div>

          <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-6 transform hover:scale-105 transition-all duration-300 glow-effect">
            <PenTool className="h-8 w-8 text-primary mx-auto mb-3" />
            <h3 className="font-serif font-semibold text-lg text-foreground mb-2">Reviews</h3>
            <p className="text-muted-foreground text-sm">Tools, frameworks, and resources</p>
          </div>
        </div>
      </div>
    </section>
